...
public class GamePreferences : MonoBehaviour {
	...
	public static string CurrentCoinScore = "CurrentCoinScore";
	public static string CurrentLifes = "CurrentLifes";
	public static string GameStartedFromMainMenu = "GameStartedFromMainMenu";
	public static string GameResumed = "GameResumed";
	public static string GameResumedAfterPlayerDied = "GameResumedAfterPlayerDied";
	//public static string GameScore = "GameScore";
	//public static string GameCoins = "GameCoins";
	//public static string GameLifes = "GameLifes";
	...
	//public static string CurrentCameraSpeed = "CurrentCameraSpeed";
	public static string MainMenuOpenedFromGameplay = "MainMenuOpenedFromGameplay";
